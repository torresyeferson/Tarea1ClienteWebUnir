...
<html>
    ...
    <body>
            ...
            <div class="flex-align contenedor-interno header-section">
                ...
                <nav  id="main-header">
                    <ul class="flex-align">
                        ...
                        <li><a  class=" grey-darken-text" href="#">Productos</a></li>
        ...
        <div class="grey-light grey-darken-text equipos ">
            <div class="contenedor-interno"> 
                <h1><strong>Equipos</strong> de escritorio</h1>
                <div class="flex-align">  
                    <div class="item-align" >
                        <img src="../assets/images/image2.png">
                        <h3>TOSHIBA +CORE I3 +4GB +1TB +15"+ WIN XP</h3>
                        <p>$ 500,00</p>
                    </div>
                    <div class="item-align" >
                        <img src="../assets/images/escritorio-dell.png">
                        <h3>DELL +CORE I5 +8GB +1TB +13"+ WIN 8.1</h3>
                        <p>$ 660,00</p>
                    </div>
                    <div class="item-align" >
                        <img src="../assets/images/dell-escritorio.png">
                        <h3>DELL +CORE I2 +4GB +512TB +15"+ WIN 7</h3>
                        <p>$ 430,00</p>
                    </div>
                </div> 

                <h1><strong>Equipos</strong> portatiles</h1>
                <div class="flex-align">  
                    <div class="item-align" >
                        <img src="../assets/images/image1.png">
                        <h3>ACER + CORE I7 +12GB +1TB +15" LED +WIN 8.1</h3>
                        <p> $ 700,00</p>
                    </div>
                    <div class="item-align" >
                        <img src="../assets/images/portatil-hp.png">
                        <h3>HP + CORE I7 +8GB +1TB +13" +WIN 8.1</h3>
                        <p> $ 860,00</p>
                    </div>
                    <div class="item-align" >
                        <img src="../assets/images/laptop-dell.png"><br><br>
                        <h3>DELL + CORE I3 +8GB +1TB +15" +WIN 8.1</h3>
                        <p> $ 740,00</p>
                    </div>
                </div> 

                <h1><strong>Accesorios</strong> adicionales</h1>
                <div class="flex-align">  
                    <div class="item-align" >
                    ...
                    <div class="item-align" >
                        <img src="../assets/images/teclado.png">
                        <h3>Teclado inalámbrico</h3>
                        <p>$ 25,00</p>
                    </div>
                    <div class="item-align" >
                        <img src="../assets/images/audifonos.png">
                        <h3>Audífonos</h3>
                        <p>$ 15,00</p>
                    </div>
                </div> 
